...
class RecentDbQueriesTable extends DataTableComponent
{
    ...
    {
        return LaraMonDbQuery::query();
    }

    public function columns(): array
    {
        return [
            Column::make('Query Type', 'query_type')
                ->sortable()
                ->searchable()
            ...
            Column::make('Execution Time (ms)', 'execution_time')
                ->sortable()
